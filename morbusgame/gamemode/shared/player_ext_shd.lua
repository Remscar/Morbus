...
function plymeta:IsGame()
	return self:Team() == TEAM_GAME
end
...
function plymeta:GetBrood()
	return self:GetRole() == ROLE_BROOD
end

function plymeta:GetSwarm()
	return self:GetRole() == ROLE_SWARM
end

function plymeta:GetHuman()
	return self:GetRole() == ROLE_HUMAN
end
...
function plymeta:IsActiveRole(role)
	return self:IsRole(role) and (GetRoundState() == ROUND_ACTIVE)
end

function plymeta:IsActiveBrood()
	return self:IsActiveRole(ROLE_BROOD)
end

function plymeta:IsActiveSwarm()
	return self:IsActiveRole(ROLE_SWARM)
end

function plymeta:IsActiveSpecial()
	return self:IsSpecial() and (GetRoundState() == ROUND_ACTIVE)
end

function plymeta:IsActiveAlien()
	return self:IsActiveRole(ROLE_BROOD) or self:IsActiveRole(ROLE_SWARM)
end

function plymeta:IsActiveHuman()
	return self:IsActiveRole(ROLE_HUMAN)
end
