function EFFECT:Init(ed)
	...
	for i= 1, math.random(25, 64) do

		local part = pe:Add("sprites/glow04_noz", vOrig)

		if (part) then

			part:SetColor(255, 185, 0, math.random(150, 255))
			part:SetVelocity(VectorRand():GetNormal() * math.random(10, 180))
	...
	for i= 1, math.random(5, 10) do
		...
		if (part) then
			...
			part:SetColor(255, 185, 0, math.random(150, 255))
			part:SetVelocity(VectorRand():GetNormal() * math.random(40, 140))
			part:SetRoll(math.Rand(0, 360))
			part:SetRollDelta(math.Rand(-15, 15))
			part:SetDieTime(0.8)
			part:SetLifeTime(0)
	...
	local effectdata = EffectData()
		effectdata:SetOrigin( vOrig )
			sound.Play("weapons/blaster/blaster_hit.wav", vOrig, 100, math.random(95,125))
